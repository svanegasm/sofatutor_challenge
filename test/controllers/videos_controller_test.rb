...
class VideosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create video" do
    assert_difference('Video.count') do
      post videos_url, params: { video: { subject_id: @video.subject_id, title: @video.title } }
    end
  ...
  test "should update video" do
    patch video_url(@video), params: { video: { subject_id: @video.subject_id, title: @video.title } }
